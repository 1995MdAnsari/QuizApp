...
class KidsQuiz extends Component{
    ...
    showQuestions = () =>{
        let s= {...this.state};
        let arr = s.arrNew[s.currIndex-1];
        return(
            <React.Fragment>
             <img src={arr.img} alt="images" 
                className='img-fluid' 
    ...
    render() {
        let {show,personName,errors,errorMsg,imgShow,currIndex} = this.state;
            ...
            <React.Fragment>
                ...
                <React.Fragment>
                    <div className="container">
                        <h3>Question Number : {currIndex+1}</h3>
                        {imgShow===1 ?this.showQuestions():""}
